...
public class EstadoController {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<EstadoResponseDTO> updateById(@PathVariable Long id,
      @RequestBody EstadoRequestDTO estado) {
    return ResponseEntity.status(HttpStatus.OK).body(estadoService.updateById(id, estado));
  }
